...
To get a better understanding of how to use the library, see the how to guide for using the functions in the library [here](https://jaseziv.github.io/euroleagueR/articles/using-euroleagueR.html)
